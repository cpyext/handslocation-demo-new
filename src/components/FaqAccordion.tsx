      ...
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-300 rounded-lg">
            ...
            <div className={`px-4 pb-4 ${openFaq === 1 ? '' : 'hidden'}`}>
              <p className="mb-4 text-base" style={{ color: '#000000' }} >
          ...
          <div className="border border-gray-300 rounded-lg">
            ...
            <div className={`px-4 pb-4 ${openFaq === 2 ? '' : 'hidden'}`}>
              <p className="mb-4 text-base" style={{ color: '#000000' }}>
          ...
          <div className="border border-gray-300 rounded-lg">
            ...
            <div className={`px-4 pb-4 ${openFaq === 3 ? '' : 'hidden'}`}>
              <p className="mb-4 text-base" style={{ color: '#000000' }}>
